...
var _users = _interopRequireDefault(require("../initialise-dev/users"));
var _dotenv = _interopRequireDefault(require("dotenv"));
var _movieModel = _interopRequireDefault(require("../api/movies/movieModel"));
var _movies = _interopRequireDefault(require("../initialise-dev/movies"));
...
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; } // import genreModel from '../api/genres/genreModel'
...
function _loadMovies() {
  _loadMovies = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2() {
...
function _loadReviews() {
  _loadReviews = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3() {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _context3.prev = 1;
          _context3.next = 4;
          return _reviewModel["default"].deleteMany();
        case 4:
          _context3.next = 6;
          return _reviewModel["default"].collection.insertMany(_reviews["default"]).then(console.info("".concat(_reviews["default"].length, " reviews were successfully stored.")));
        case 6:
          _context3.next = 11;
          break;
        case 8:
          ...
          console.error("failed to Load review Data: ".concat(_context3.t0));
        case 11:
        case "end":
